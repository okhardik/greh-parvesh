...
export default function GrihaPraveshInvitation({ language }: GrihaPraveshInvitationProps) {
  const content = {
    ...
    hi: {
      ...
      intro1: "दिल से आभार और खुशी के साथ, 💖",
      intro2: "हम आपको आमंत्रित करते हैं हमारे",
      pujaTitle: "🏠 गृह प्रवेश पूजा",
      pujaDesc: "जहां हम अपने नए घर में कदम रखकर एक नई और सुंदर शुरुआत करने जा रहे हैं। 🌟",
      blessings: "आपकी उपस्थिति और आशीर्वाद हमारे लिए अनमोल होंगे। 🌍",
      specialDay: "आपका साथ इस दिन को और भी खास बना देगा। ✨",
      dateLabel: "दिनांक",
